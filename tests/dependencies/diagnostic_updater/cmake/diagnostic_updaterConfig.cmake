...
if("FALSE" STREQUAL "TRUE")
  set(diagnostic_updater_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-diagnostic-updater-1.9.3)
  set(diagnostic_updater_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-diagnostic-updater-1.9.3/obj-x86_64-linux-gnu/devel)
  ...
  set(diagnostic_updater_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diagnostic_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
